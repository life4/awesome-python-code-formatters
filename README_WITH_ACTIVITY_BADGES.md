...
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/prettier/prettier)|![GitHub last commit](https://img.shields.io/github/last-commit/prettier/prettier)| [prettier](https://github.com/prettier/prettier) | opinionated code formatter, not only for Python.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/google/yapf)|![GitHub last commit](https://img.shields.io/github/last-commit/google/yapf)| [yapf](https://github.com/google/yapf) | yet another Python code formatter from Google.|
...
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/myint/docformatter)|![GitHub last commit](https://img.shields.io/github/last-commit/myint/docformatter)| [docformatter](https://github.com/myint/docformatter) | formats docstrings to follow PEP 257.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/LilSpazJoekp/docstrfmt)|![GitHub last commit](https://img.shields.io/github/last-commit/LilSpazJoekp/docstrfmt)| [docstrfmt](https://github.com/LilSpazJoekp/docstrfmt) | a tool for automatically formatting reStructuredText in files and Python docstrings in a consistent way.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/myint/eradicate)|![GitHub last commit](https://img.shields.io/github/last-commit/myint/eradicate)| [eradicate](https://github.com/myint/eradicate) | removes commented-out code from Python files.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/PeterJCLaw/fix8)|![GitHub last commit](https://img.shields.io/github/last-commit/PeterJCLaw/fix8)| [fix8](https://github.com/PeterJCLaw/fix8) | fixes some Python linting issues found by Flake8.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/ikamensh/flynt)|![GitHub last commit](https://img.shields.io/github/last-commit/ikamensh/flynt)| [flynt](https://github.com/ikamensh/flynt) | converts old string literal formatting to f-strings.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/python-formate/formate)|![GitHub last commit](https://img.shields.io/github/last-commit/python-formate/formate)| [formate](https://github.com/python-formate/formate) | a wrapper around `isort` and `yapf` with a few custom rules.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/Kludex/kwonly-transformer)|![GitHub last commit](https://img.shields.io/github/last-commit/Kludex/kwonly-transformer)| [kwonly-transformer](https://github.com/Kludex/kwonly-transformer)  | Opinionated tool to ensure functions with multiple parameters to have exclusively keyword only parameters.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/Kludex/no-optional)|![GitHub last commit](https://img.shields.io/github/last-commit/Kludex/no-optional)| [no-optional](https://github.com/Kludex/no-optional)  | Replace `Optional[T]` by `Union[T, None]`.|
||| [pybetter](https://pypi.org/project/pybetter/) | fixes some trivial problems with your code.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/DanielNoord/pydocstringformatter)|![GitHub last commit](https://img.shields.io/github/last-commit/DanielNoord/pydocstringformatter)| [pydocstringformatter](https://github.com/DanielNoord/pydocstringformatter) | Automatically format your Python docstrings to conform with PEP 8 and PEP 257.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/dadadel/pyment)|![GitHub last commit](https://img.shields.io/github/last-commit/dadadel/pyment)| [pyment](https://github.com/dadadel/pyment) | formats and generates docstrings.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/python/cpython/blob/master/Tools/scripts/reindent.py)|![GitHub last commit](https://img.shields.io/github/last-commit/python/cpython/blob/master/Tools/scripts/reindent.py)| [reindent.py](https://github.com/python/cpython/blob/master/Tools/scripts/reindent.py) | changes Python files to use 4-space indents and no hard tab characters.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/bwhmather/ssort)|![GitHub last commit](https://img.shields.io/github/last-commit/bwhmather/ssort)| [ssort](https://github.com/bwhmather/ssort) | sorts and groups classes, functions, and methods.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/isidentical/teyit)|![GitHub last commit](https://img.shields.io/github/last-commit/isidentical/teyit)| [teyit](https://github.com/isidentical/teyit) | formats unittest assertions.|
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/myint/unify)|![GitHub last commit](https://img.shields.io/github/last-commit/myint/unify)| [unify](https://github.com/myint/unify) | modifies strings to all use the same quote where possible.|
...
|![GitHub last commit](https://img.shields.io/github/commit-activity/y/dizballanze/gray)|![GitHub last commit](https://img.shields.io/github/last-commit/dizballanze/gray)| [gray](https://github.com/dizballanze/gray) | wrapper around `isort`, `pyupgrade`, `add-trailing-comma`, and `unify`.|
